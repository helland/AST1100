...
if __name__ == '__main__':
    ...
    vx0 = -2037#37#-0.2      #au per year         #initial x velocity of planet
    vy0 = -810#10 #-0.2       #1000 (m/s) *3.154e+7 (1 year in seconds) / 1.496e+11 (1 au)
    ...
    A = 500 #*(6.68459*10**-12)**2 #size of parachute in square au
    #print p 
    #print A
    ...
    dt = 0.1 #3.16887646 * 10**-8 # 10 second in years #400.0/(3.154*10**7)  #time interval (0.0000126823) 
