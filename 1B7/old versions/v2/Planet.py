...
class planet():
    ...
    def __call__(self, T, N):                
        ...
        #self.Xpos = np.zeros(N) # set array of x position values
        #self.Ypos = np.zeros(N) # set array of y position values
        #self.Xvel = np.zeros(N) # set array of x velocity values
        #self.Yvel = np.zeros(N) # set array of y velocity values
